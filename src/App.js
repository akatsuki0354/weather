...
function App() {
  ...
  const handleSubmit = async (event) => {
    ...
    // const url = `https://api.weatherapi.com/v1/current.json?key=${apiKey}&q=${name}&aqi=no`;


    const url = `https://api.weatherapi.com/v1/forecast.json?key=6ba551e0ee3a40229dd80510250801&q=${name}&days=1&aqi=no&alerts=no`;
    try {
  ...
  return (
    <div className="App ">
      <div>
        ...
        <div className='lg:flex lg:justify-around container'>
          ...
          <div className="mt-3 text-muted">
            {max_temp === null ? (
              ...
              <div>
                <center>
                  <h4 className='md:text-xl lg:text-3xl mb-2'>{country}, {region}</h4>
                  <h1 className='md:text-2xl lg:text-4xl mb-2'> {temp} &#8451;</h1>
                ...
                <div className='condtion_and_tem mt-10 gap-5 md:gap-10 lg:space-x-10'>
                  <div>
                    <center>
                      ...
                      <p className='lg:text-2xl mt-3 font-semibold'>Sunrise</p>
                      ...
                      <p className='lg:text-2xl font-semibold'>{sunrise}</p>
                    </center>
                  </div>
                  <div>
                    <center>
                      <p className='text-xl'>Lowest : {min_temp} &#8451;</p>
                      <p className='lg:text-2xl mt-3 font-semibold'>Sunset </p>
                      ...
                      <p className='lg:text-2xl font-semibold'>{sunset}</p>
                    </center>
                  </div>
                </div>
                <div>
